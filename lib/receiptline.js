...
(function () {
     ...
     */
     function parseOption(printer) {
        ...
        return {
            cpl: p.cpl || 48,
            encoding: supportedEncodings.includes(p.encoding) ? p.encoding : 'cp437',
    ...
    if (typeof window !== 'undefined') {
        window.receiptline = { transform: transform, createTransform: createTransform, commands: commands, supportedEncodings: supportedEncodings };
    }
    // Node.js
    if (typeof module !== 'undefined') {
        module.exports = { transform: transform, createTransform: createTransform, commands: commands, supportedEncodings: supportedEncodings };
    }
